"""
api/alembic/env.py
Configuración de Alembic para migraciones de la API SaaS.
"""
...
from api.app.models import Tenant, User, Course  # noqa: F401 (registra modelos en Base.metadata)

# Alembic Config object
config = context.config

# Inyectar la DATABASE_URL real desde settings
